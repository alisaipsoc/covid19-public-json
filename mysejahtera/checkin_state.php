 ...
 * 
 */
$url = "https://raw.githubusercontent.com/MoH-Malaysia/covid19-public/main/mysejahtera/checkin_state.csv";
...
/**
 * Collect all dates available in checkin_state.csv
 * 
 */
            ...
            if ($data[$i][0] == $date) {
                if ($data[$i][1] == $state) {
                    ...
                    foreach ($details as $detail) {
                        $checkin_state[$date][$state][$detail] = $data[$i][$j];
                        $j++;
                    }
                }
            }
...
/**
 * Encode the checkin_state as a JSON.
 * 
 */
$checkin_state = json_encode($checkin_state, JSON_PRETTY_PRINT);
